...
export default class LongBranchesPattern extends React.PureComponent<Props, State> {
  mounted: boolean;
  state: State = { formOpen: false, loading: true };
  ...
  fetchSetting() {
    ...
    getValues(LONG_BRANCH_PATTERN, this.props.project).then(
      settings => {
        if (this.mounted) {
  ...
  render() {
    ...
    return (
      <div className="pull-right text-right">
        ...
        <a
          className="display-inline-block big-spacer-left link-no-underline"
          href="#"
